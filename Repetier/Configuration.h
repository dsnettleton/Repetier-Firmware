...
#define EXT0_PID_P 27.07
/** I-gain.  Overridden if EEPROM activated.*/
#define EXT0_PID_I 1.63
/** Dgain.  Overridden if EEPROM activated. */
#define EXT0_PID_D 112.17
...
// for skeinforge 40 and later, steps to pull the plasic 1 mm inside the extruder, not out.  Overridden if EEPROM activated.
#define EXT1_STEPS_PER_MM 92.65
// What type of sensor is used?
// 1 is 100k thermistor (Epcos B57560G0107F000 - RepRap-Fab.org and many other)
// 2 is 200k thermistor
// 3 is mendel-parts thermistor (EPCOS G550)
...
//  Overridden if EEPROM activated.
#define EXT1_MAX_FEEDRATE 40
// Feedrate from halted extruder in mm/s
//  Overridden if EEPROM activated.
#define EXT1_MAX_START_FEEDRATE 10
// Acceleration in mm/s^2
//  Overridden if EEPROM activated.
#define EXT1_MAX_ACCELERATION 3500
/** Type of heat manager for this extruder. 
- 0 = Simply switch on/off if temperature is reached. Works always.
- 1 = PID Temperature control. Is better but needs good PID values. Defaults are a good start for most extruder.
 Overridden if EEPROM activated.
...
/** P-gain.  Overridden if EEPROM activated. */
#define EXT1_PID_P   11.63
/** D-gain.  Overridden if EEPROM activated.*/
#define EXT1_PID_I   0.43
/** Dgain.  Overridden if EEPROM activated. */
#define EXT1_PID_D 78.65
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
...
#define ENDSTOP_X_BACK_MOVE 5.0
#define ENDSTOP_Y_BACK_MOVE 5.0
#define ENDSTOP_Z_BACK_MOVE 5.0
...
#define X_MAX_LENGTH 327.662
#define Y_MAX_LENGTH 327.662
#define Z_MAX_LENGTH 327.662
...
#if MOTHERBOARD==301
#define MOTOR_CURRENT {165,165,165,145,0} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)  use 140 for xyz and 160 for the E if using Kysan motors and 175 xyz and 200 if using wantai motors
#elif MOTHERBOARD==12
...
#define UI_PRINTER_NAME " Fabricatus Maximus"
...
#define BEEPER_LONG_SEQUENCE 4,4
...
#define UI_SET_MIN_EXTRUDER_TEMP   155
